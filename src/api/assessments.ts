...
export function useAssessment(codigo: string) {
  return useQuery<Assessment>({
    ...
    queryFn: () => authGet<Assessment>(`${API_ENDPOINTS.ASSESSMENTS}/${codigo}`),
    enabled: !!codigo
  });
}
...
export function useSubmitAssessment(codigo: string) {
  ...
  return useMutation({
    ...
    mutationFn: (input: SubmitAnswersInput) =>
      authPost<SubmissionResult>(`${API_ENDPOINTS.ASSESSMENTS}/${codigo}`, input),
    onSuccess: () => {
...
export function useAssessmentQuestions(codigo: string) {
  return useQuery<Question[]>({
    ...
    queryFn: () => authGet<Question[]>(`${API_ENDPOINTS.ASSESSMENTS}/${codigo}/questions`),
    enabled: !!codigo
  });
}
...
export function useCreateQuestion(codigo: string) {
  ...
  return useMutation({
    ...
    mutationFn: (input: CreateQuestionInput) =>
      authPost<Question>(`${API_ENDPOINTS.ASSESSMENTS}/${codigo}/questions`, input),
    onSuccess: () => {
...
export function useQuestionAlternatives(questaoId: string) {
  return useQuery<Alternative[]>({
    ...
    queryFn: () => authGet<Alternative[]>(`${API_ENDPOINTS.ASSESSMENTS}/questions/${questaoId}/alternatives`),
    enabled: !!questaoId
  });
}
...
export function useCreateAlternative(questaoId: string) {
  ...
  return useMutation({
    ...
    mutationFn: (input: CreateAlternativeInput) =>
      authPost<Alternative>(`${API_ENDPOINTS.ASSESSMENTS}/questions/${questaoId}/alternatives`, input),
    onSuccess: () => {
      queryClient.invalidateQueries({ queryKey: ['assessments', 'alternatives', questaoId] });
    }
  });
}
...
export function useDissertativeResponses(attemptId: string) {
  return useQuery<DissertativeResponse[]>({
    ...
    queryFn: () => authGet<DissertativeResponse[]>(`${API_ENDPOINTS.ASSESSMENTS}/attempts/${attemptId}/dissertative`),
    enabled: !!attemptId
  });
}
...
export function useReviewAttempt(attemptId: string) {
  ...
  return useMutation({
    ...
    mutationFn: (input: ReviewInput) =>
      authPatch(`${API_ENDPOINTS.ASSESSMENTS}/attempts/${attemptId}/review`, input),
    onSuccess: () => {
      queryClient.invalidateQueries({ queryKey: ['assessments', 'dissertative', attemptId] });
      queryClient.invalidateQueries({ queryKey: ['assessments', 'attempts'] });
    }
  });
}
