...
export function useUnreadNotificationsCount() {
  return useQuery<UnreadCountResponse>({
    ...
    queryFn: () => authGet<UnreadCountResponse>(`${API_ENDPOINTS.NOTIFICATIONS}/notificacoes/count`),
...
export function useCreateNotification() {
  ...
  return useMutation({
    ...
    mutationFn: (input: CreateNotificationInput) =>
      authPost<Notification>(`${API_ENDPOINTS.NOTIFICATIONS}/notificacoes`, input),
    onSuccess: () => {
...
export function useMarkNotificationAsRead() {
  ...
  return useMutation({
    ...
    mutationFn: (notificationId: number) =>
      authPut(`${API_ENDPOINTS.NOTIFICATIONS}/notificacoes/${notificationId}/read`),
    onSuccess: () => {
      queryClient.invalidateQueries({ queryKey: ['notifications', 'list'] });
      queryClient.invalidateQueries({ queryKey: ['notifications', 'unread-count'] });
    }
...
export function useMarkAllNotificationsAsRead() {
  ...
  return useMutation({
    ...
    mutationFn: () =>
      authPut<MarkAllAsReadResponse>(`${API_ENDPOINTS.NOTIFICATIONS}/notificacoes/read-all`),
    onSuccess: () => {
      queryClient.invalidateQueries({ queryKey: ['notifications', 'list'] });
      queryClient.invalidateQueries({ queryKey: ['notifications', 'unread-count'] });
    }
...
export function useUserNotifications(usuarioId: string) {
  return useQuery({
    ...
    queryFn: () => authGet(`${API_ENDPOINTS.NOTIFICATIONS}/notificacoes/${usuarioId}`),
    enabled: !!usuarioId
  });
}
